                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}">
                                                                {{-- <img style="width:72px;border:0px;display: inline!important;" src="{{ config('pleb.mail.top_logo') }}" width="72" border="0"       alt="logo"> --}}
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                {{-- <a href="{{ config('pleb.mail.welcome_url') }}" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>GET STARTED</span></a> --}}
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="https://www.simple-pleb.com/assets/img/emails/Email-1_Icon-1.png" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="https://www.simple-pleb.com/assets/img/emails/Email-1_Icon-2.png" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
